...
with DAG('language_detection', default_args=default_args, schedule_interval=None) as dag:
    ...
    translate_task = PythonOperator(
        ...
        op_kwargs={"text": example_text, "language": "pl"} # todo pass argument from downstream task
    )
